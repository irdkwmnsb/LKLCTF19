...
Пока идея такова: будет самописная вебморда, эмулирующая Wireless IP Camera (P2P) WIFICAM, нужно будет нагуглить её [уязвимости](https://pierrekim.github.io/blog/2017-03-08-camera-goahead-0day.html)

В описании соот. скажем что есть камера кодовая база которой схожа с указанной выше и что версия ПО достаточно старая, мол поищите zeroday в инете
